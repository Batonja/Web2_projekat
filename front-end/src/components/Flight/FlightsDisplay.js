                              ...
                              <Container fluid className="flightWrap">
                                <Row className="flightPresentRow">
                                  ...
                                  <Col md="auto" className="flightArrow">
                                    <Button
                                      onClick={(e) =>
                                        this.openClose(e, flight.flightId)
                                      }
                                    >
                                      {this.isOpened(flight.flightId) ? (
                                        <KeyboardArrowUpIcon />
                                      ) : (
                                ...
                                <Collapse
                                  isOpened={this.isOpened(flight.flightId)}
                                >
                                  <Row className="flightPresentRow">
                                    ...
                                    <Col md="auto" className="flightItem">
                                      ...
                                      flight.Id ? (
                                        <Alert variant="warning">
                                          ...
                                          fast reservation seat available, next
                                          time you should be faster
                                        </Alert>
                                      ) : (
                                        ""
                                      )}
                                      ...
                                      flight.Id ? (
                                        <Alert variant="success">
                                          You have successfully reserved your
                                          flight
                                        </Alert>
                                      ) : (
                                        ""
